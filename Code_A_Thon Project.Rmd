...
wa_nvdrs22_comp<-wa_nvdrs22_comp %>% rename(region=ResidenceState, subregion=county)
...
suicide_cir<-c("region", "subregion", "IncidentYear_chr","IncidentNumber", "Sex", "RaceEthnicity_c","AgeYears_c", "Military", "RelationshipStatus", "AbstractorDeathmanner_c", "MentalHealthProblem_c", "DepressedMood_c", "AlcoholProblem_c", "MentalIllnessTreatmentCurrnt_c", "HistoryMentalIllnessTreatmnt_c, IntimatePartnerProblem_c, Argument_c,SuicideThoughtHistory,SuicideAttemptHistory_c,HistorySelfHarm_c,SuicideIntentDisclosed_c,DisclosedToIntimatePartner_c,DisclosedToOtherFamilyMember_c,DisclosedToHealthCareWorker_c,DisclosedToFriend_c,DisclosedToNeighbor_c,DisclosedToSocialMedia_c,SuicideNote_c,PhysicalHealthProblem_c,JobProblem_c,FinancialProblem_c,SchoolProblem_c,EvictionOrLossOfHome_c,WeaponType1)

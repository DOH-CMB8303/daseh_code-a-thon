...
wa_nvdrs22_comp_suicidecir %>% is.na("ResidenceZip")
```
...
wa_nvdrs22_suicidecir_MHP<-wa_nvdrs22_comp_suicidecir %>% 
  select(c("ResidenceState","ResidenceFIPS", "ResidenceZip", "IncidentYear_chr","MentalHealthProblem_c")) %>% 
  filter()

wa_nvdrs22_suicidecir_MHP %>% count(MentalHealthProblem_c=="No, Not Available, Unknown",ResidenceZip)

wa_nvdrs22_comp_suicidecir %>% table("ResidenceZip", "MentalHealthProblem_c")
```
